...
<body style="margin:0;height: 100%;outline:none;color: #042A38f !important;padding-botton:5vw;background-color: #0E1D3E;">
    <div class="bg" style="font-weight: bolder;background-image: url(./image);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: 100%;">
        <center>
