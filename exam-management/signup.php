...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #0E1D3E !important">
    <div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-color:#0E1D3E;height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
